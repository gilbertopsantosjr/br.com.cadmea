...
public class CustomUserDetailsService implements UserDetailsService {
  ...
  @Value("${cadmea.users.sql.loginByUsername:SELECT u.usu_id as id, u.usu_pwd as password, u.usu_email as email, u.usu_username as nickname, u.usu_situation FROM cadmea_user_system u WHERE u.usu_email = ? and u.usu_situation = 1}")
