...
public final class SpringFunctions {
	...
	public static UserAccess getCurrentUser() {
	    ...
	    if (principal instanceof UserAccess) return ((UserAccess) principal);
	    return null;
	}

	public static String getNameOfUser(){
		return ((UserAccess) SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getNickname();
	}
	
	/**
	 * verifica varias permissoes para o usuario que possui permissao de acesso 
	 * @param roles
	 * @return Boolean verdadeiro se o perfil do usuario logado permitir visualizar o conteudo
	 */
	 ...
	 * @param role
	 * @return verdadeiro se o perfil do usuario logado permitir visualizar o conteudo
	 */
