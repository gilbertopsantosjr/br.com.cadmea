...
public abstract class DaoGenericoImp<T extends BaseEntityPersistent, ID extends Serializable>
	...
	@Override
	public T findByNamedQuery(String namedQuery, Map<String, Object> parameters, Result resultado) {
		T retorno = null;
	...
	@Override
	public T find(String propriedade, Object valor, Result res) throws DaoException {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put(propriedade, valor);
	...
	@Override
	public T find(Map<String, Object> params, Result resultado) throws DaoException {
