<div class="row">
	<div class="input-field col s6">
		<input id="name" ng-model="user.entity.person.name" type="text"> 
		<label for="name">Name</label>
	</div>
	<div class="input-field col s6">
	 <input id="dob" type="date" ng-model="user.entity.person.dateOfBirth" class="datepicker">
	</div>
</div>

<div class="row">
	<div class="input-field col s12">
		<input id="surname" ng-model="user.entity.person.surname" type="text"> 
